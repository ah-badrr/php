...
if (isset($_GET['search']) or isset($_GET['cari'])) {
    $search = $_GET['search'];
    $cari = "SELECT * FROM soal 
    WHERE nama_soal LIKE '%$search%'
    OR jenis_soal LIKE '%$search%' ";
        ...
        <div class="row mt-4">
            <div class="col-md-12 col-lg-3">
                <ul class=" shadow list-group">
                    ...
                    <li class="list-group-item bg-info bg-opacity-25 "><a class="text-dark text-decoration-none" href="../soal/index.php">Manage Soal</a></li>
                </ul>
            </div>
                        ...
                        <tbody class="table-group-divider">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php if ($data['jenis_soal'] == 't') {
                                            echo "Tugas";
                                        } else if ($data['jenis_soal'] == 'k') {
                                            echo "Kuis";
                                        } else {
                                            echo "Ujian";
                                        } ?></td>
