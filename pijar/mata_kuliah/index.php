...
$query = "SELECT kategori.kategori, pengajar.nama, mata_kuliah.* FROM mata_kuliah INNER JOIN kategori ON mata_kuliah.kategori_id = kategori.id INNER JOIN pengajar ON mata_kuliah.pengajar_id = pengajar.id";
$mata_kuliah = mysqli_query($connect, $query);

if (isset($_GET['search']) or isset($_GET['cari'])) {
    $search = $_GET['search'];
    $cari = "SELECT kategori.kategori, pengajar.nama, mata_kuliah.* FROM mata_kuliah INNER JOIN kategori ON mata_kuliah.kategori_id = kategori.id INNER JOIN pengajar ON mata_kuliah.pengajar_id = pengajar.id 
    WHERE nama_matkul LIKE '%$search%'
    OR nama LIKE '%$search%'
    OR kategori LIKE '%$search%'";

    $mata_kuliah = mysqli_query($connect, $cari);
...
<body>
    <div class="container pb-5">
        <div class=" shadow  border-0 card mt-5 text-light bg-primary">
        ...
        <div class="row mt-4">
            <div class="col-md-12 col-lg-3">
                <ul class=" shadow list-group">
                    ...
                    <li class="list-group-item bg-info bg-opacity-25 "><a class="text-dark text-decoration-none" href="../mata_kuliah/index.php">Manage Mata_kuliah</a></li>
            ...
            <div class="col-md-12 col-lg-9">
                <form method="GET" class="row float-end row-cols-lg-auto g-2 align-items-center">
                    ...
                    <div class="col-12">
                        <button type="submit" name="cari" class="btn shadow  btn-success">
