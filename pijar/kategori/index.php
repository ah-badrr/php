...
if (isset($_GET['search']) or isset($_GET['cari'])) {
    $search = $_GET['search'];
    $cari = "SELECT kategori.kategori FROM kategori WHERE kategori LIKE '%$search%'";

    $kategori = mysqli_query($connect, $cari);
...
<body>
    <div class="container pb-5">
        <div class="card border-0 shadow  mt-5 text-light bg-primary">
        ...
        <div class="row mt-4">
            <div class="col-md-12 col-lg-3">
                <ul class="list-group shadow ">
                    ...
                    <li class="list-group-item bg-info bg-opacity-25 "><a class="text-dark text-decoration-none" href="../kategori/index.php">Manage Kategori</a></< /li>
                        ...
                        <tbody class="table-group-divider">
                            ...
                            ?>
                                <tr>
                                    <th scope="row"><?= $id++ ?></th>
                                    <td><?= $data["kategori"] ?></td>
                                    <!-- batasi tampilan string dari deskripsi jika lebih dari 100 -->
                                    <td>
